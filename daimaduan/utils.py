...
RESET_PASSWORD_CONTENT = u"<p>你好 %s,</p> \
    <p>您已请求重置代码段密码. 请点击<a href=\"http://preview.daimaduan.com/reset_password/%s\">链接</a>来重置您的密码.</p> \
            <p>或者您可以拷贝下面这个地址到您的浏览器中访问来重置您的密码 http://preview.daimaduan.com/reset_password/%s </p> \
            <br> \
            <p>此致！</p> \
            <p>代码段团队</p>"
